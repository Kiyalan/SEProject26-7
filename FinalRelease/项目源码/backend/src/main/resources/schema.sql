...
ALTER TABLE issue_analysis ADD COLUMN IF NOT EXISTS replied BOOLEAN DEFAULT FALSE;
ALTER TABLE issue_analysis ADD COLUMN IF NOT EXISTS replied_at VARCHAR(32) DEFAULT '';
