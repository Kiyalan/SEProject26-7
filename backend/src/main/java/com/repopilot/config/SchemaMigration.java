...
public class SchemaMigration {
    ...
    public SchemaMigration(JdbcTemplate jdbc) {
        migrate(jdbc, "issue_labels", "ALTER TABLE issue_analysis ADD COLUMN issue_labels LONGTEXT");
    ...
    private void migrate(JdbcTemplate jdbc, String column, String ddl) {
        try {
            boolean exists = Boolean.TRUE.equals(jdbc.query(
                    ...
                    WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'issue_analysis' AND COLUMN_NAME = ?
                    """,
